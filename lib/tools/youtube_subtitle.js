...
import {
  ...
  findExistingVideoSubdirectoryByVideoId,
...
export async function handler(args = {}) {
  ...
  // Why: prefer the existing video subfolder, else create a new timestamped one
  ...
  const outputDirectoryPath = outputPathRaw
    ...
    : findExistingVideoSubdirectoryByVideoId(videoId) || createTimestampedVideoSubdirectory(videoId);
